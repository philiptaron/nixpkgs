...
let
  ...
  commonNetworkOptions = {
    ...
    extraConfig = mkOption {
      default = "";
      type = types.lines;
      description = mdDoc "Extra configuration append to unit";
    };
  };
  ...
  commonOptions = visible: {
    ...
    links = mkOption {
      ...
      description = mdDoc "Definition of systemd network links.";
    };
    ...
    netdevs = mkOption {
      ...
      description = mdDoc "Definition of systemd network devices.";
    };
    ...
    networks = mkOption {
      ...
      description = mdDoc "Definition of systemd networks.";
    };
    ...
    config = mkOption {
      ...
      description = mdDoc "Definition of global systemd network config.";
    };

    units = mkOption {
      description = mdDoc "Definition of networkd units.";
      default = {};
      internal = true;
  ...
  in mkMerge [
    ...
    (mkIf config.systemd.network.enable {
      ...
      systemd.services.systemd-networkd = let
        ...
        reloadableUnitFiles = filterAttrs (k: v: isReloadableUnitFileName k) unitFiles;
        nonReloadableUnitFiles = filterAttrs (k: v: !isReloadableUnitFileName k) unitFiles;
  ...
  in mkMerge [
...

    {
      ...
      # network daemons.
      systemd.network.units = filterAttrs (n: _: hasSuffix ".link" n) config.systemd.network.units;
