...

{
  ...
  options = {
    ...
    services.xtreemfs = {
      ...
      enable = mkEnableOption (mdDoc "XtreemFS");
      ...
      dir = {
        ...
        replication = {
          enable = mkEnableOption (mdDoc "XtreemFS DIR replication plugin");
          extraConfig = mkOption {
            type = types.lines;
            example = ''
      ...
      mrc = {
        ...
        replication = {
          enable = mkEnableOption (mdDoc "XtreemFS MRC replication plugin");
          extraConfig = mkOption {
            type = types.lines;
            example = ''
              # participants of the replication including this replica
