  ...
  options = {
    ...
    services.xserver.synaptics = {
      ...
      enable = mkOption {
        type = types.bool;
        default = false;
        description = mdDoc "Whether to enable touchpad support. Deprecated: Consider services.xserver.libinput.enable.";
      };
      ...
      minSpeed = mkOption {
        type = types.nullOr types.str;
        default = "0.6";
        description = mdDoc "Cursor speed factor for precision finger motion.";
      };

      maxSpeed = mkOption {
        type = types.nullOr types.str;
        default = "1.0";
        description = mdDoc "Cursor speed factor for highest-speed finger motion.";
      };
      ...
      scrollDelta = mkOption {
        ...
        default = null;
        example = 75;
        description = mdDoc "Move distance of the finger for a scroll event.";
      };

      twoFingerScroll = mkOption {
        type = types.bool;
        default = false;
        description = mdDoc "Whether to enable two-finger drag-scrolling. Overridden by horizTwoFingerScroll and vertTwoFingerScroll.";
      };
      ...
      horizTwoFingerScroll = mkOption {
        ...
        description = mdDoc "Whether to enable horizontal two-finger drag-scrolling.";
      };
      ...
      vertTwoFingerScroll = mkOption {
        ...
        default = cfg.twoFingerScroll;
        defaultText = literalExpression "config.${opt.twoFingerScroll}";
        description = mdDoc "Whether to enable vertical two-finger drag-scrolling.";
      };
      ...
      horizEdgeScroll = mkOption {
        ...
        description = mdDoc "Whether to enable horizontal edge drag-scrolling.";
      };
      ...
      vertEdgeScroll = mkOption {
        ...
        description = mdDoc "Whether to enable vertical edge drag-scrolling.";
      };

      tapButtons = mkOption {
        type = types.bool;
        default = true;
        description = mdDoc "Whether to enable tap buttons.";
      };
      ...
      buttonsMap = mkOption {
        ...
        default = [1 2 3];
        example = [1 3 2];
        description = mdDoc "Remap touchpad buttons.";
        apply = map toString;
      };
      ...
      fingersMap = mkOption {
        ...
        default = [1 2 3];
        example = [1 3 2];
        description = mdDoc "Remap several-fingers taps.";
        apply = map toString;
      };
      ...
      palmDetect = mkOption {
        type = types.bool;
        default = false;
        description = mdDoc "Whether to enable palm detection (hardware support required)";
      };
      ...
      palmMinWidth = mkOption {
        ...
        default = null;
        example = 5;
        description = mdDoc "Minimum finger width at which touch is considered a palm";
      };
      ...
      palmMinZ = mkOption {
        ...
        default = null;
        example = 20;
        description = mdDoc "Minimum finger pressure at which touch is considered a palm";
      };

      horizontalScroll = mkOption {
        type = types.bool;
        default = true;
        description = mdDoc "Whether to enable horizontal scrolling (on touchpad)";
      };
