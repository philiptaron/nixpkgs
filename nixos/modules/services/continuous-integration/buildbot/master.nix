...
in {
  options = {
    services.buildbot-master = {
      ...
      factorySteps = mkOption {
        ...
        description = mdDoc "Factory Steps";
        default = [];
        example = [
      ...
      changeSource = mkOption {
        type = types.listOf types.str;
        description = mdDoc "List of Change Sources.";
        default = [];
        example = [
      ...
      configurators = mkOption {
        type = types.listOf types.str;
        description = mdDoc "Configurator Steps, see https://docs.buildbot.net/latest/manual/configuration/configurators.html";
        default = [];
        example = [
      ...
      enable = mkOption {
        type = types.bool;
        default = false;
        description = mdDoc "Whether to enable the Buildbot continuous integration server.";
      };

      extraConfig = mkOption {
        type = types.str;
        description = mdDoc "Extra configuration to append to master.cfg";
        default = "c['buildbotNetUsageData'] = None";
      };

      extraImports = mkOption {
        type = types.str;
        description = mdDoc "Extra python imports to prepend to master.cfg";
        default = "";
      ...
      masterCfg = mkOption {
        type = types.path;
        description = mdDoc "Optionally pass master.cfg path. Other options in this configuration will be ignored.";
      ...
      schedulers = mkOption {
        type = types.listOf types.str;
        description = mdDoc "List of Schedulers.";
        default = [
      ...
      builders = mkOption {
        type = types.listOf types.str;
        description = mdDoc "List of Builders.";
        default = [
      ...
      workers = mkOption {
        type = types.listOf types.str;
        description = mdDoc "List of Workers.";
      ...
      reporters = mkOption {
        default = [];
        type = types.listOf types.str;
        description = mdDoc "List of reporter objects used to present build status to various users.";
      };

      user = mkOption {
        default = "buildbot";
        type = types.str;
        description = mdDoc "User the buildbot server should execute under.";
      };

      group = mkOption {
        default = "buildbot";
        type = types.str;
        description = mdDoc "Primary group of buildbot user.";
      };

      extraGroups = mkOption {
        type = types.listOf types.str;
        default = [];
        description = mdDoc "List of extra groups that the buildbot user should be a part of.";
      };

      home = mkOption {
        default = "/home/buildbot";
        type = types.path;
        description = mdDoc "Buildbot home directory.";
      };
      ...
      buildbotDir = mkOption {
        ...
        type = types.path;
        description = mdDoc "Specifies the Buildbot directory.";
      };
      ...
      listenAddress = mkOption {
        default = "0.0.0.0";
        type = types.str;
        description = mdDoc "Specifies the bind address on which the buildbot HTTP interface listens.";
      };

      buildbotUrl = mkOption {
        default = "http://localhost:8010/";
        type = types.str;
        description = mdDoc "Specifies the Buildbot URL.";
      };

      title = mkOption {
        default = "Buildbot";
        type = types.str;
        description = mdDoc "Specifies the Buildbot Title.";
      };

      titleUrl = mkOption {
        default = "Buildbot";
        type = types.str;
        description = mdDoc "Specifies the Buildbot TitleURL.";
      };

      dbUrl = mkOption {
        default = "sqlite:///state.sqlite";
        type = types.str;
        description = mdDoc "Specifies the database connection string.";
      };

      port = mkOption {
        default = 8010;
        type = types.port;
        description = mdDoc "Specifies port number on which the buildbot HTTP interface listens.";
      };
      ...
      packages = mkOption {
        ...
        description = mdDoc "Packages to add to PATH for the buildbot process.";
      };
      ...
      pythonPackages = mkOption {
        ...
        description = mdDoc "Packages to add the to the PYTHONPATH of the buildbot process.";
  ...
  meta.maintainers = teams.buildbot.members;
}
