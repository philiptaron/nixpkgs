  ...
  options = {
    services.clamsmtp = {
      enable = mkOption {
        type = types.bool;
        default = false;
        description = mdDoc "Whether to enable clamsmtp.";
      };

      instances = mkOption {
        description = mdDoc "Instances of clamsmtp to run.";
        type = types.listOf (types.submodule { options = {
          ...
          maxConnections = mkOption {
            type = types.int;
            default = 64;
            description = mdDoc "Maximum number of connections to accept at once.";
          };
          ...
          timeout = mkOption {
            type = types.int;
            default = 180;
            description = mdDoc "Time-out for network connections.";
          };

          transparentProxy = mkOption {
            type = types.bool;
            default = false;
            description = mdDoc "Enable clamsmtp's transparent proxy support.";
          };
