  ...
  athensConfig = flip recursiveUpdate cfg.extraConfig (
    {
      ...
      GoEnv = cfg.goEnv;
      GoBinaryEnvVars = mapAttrsToList (k: v: "${k}=${v}") cfg.goBinaryEnvVars;
...
in
{
  ...
  options.services.athens = {
    enable = mkEnableOption (mdDoc "Go module datastore and proxy");

    package = mkOption {
      default = pkgs.athens;
      defaultText = literalExpression "pkgs.athens";
      example = "pkgs.athens";
      description = mdDoc "Which athens derivation to use";
      type = types.package;
    };
    ...
    goBinaryEnvVars = mkOption {
      type = types.attrs;
      description = mdDoc "Environment variables to pass to the Go binary.";
      example = ''
    ...
    goGetWorkers = mkOption {
      type = types.int;
      description = mdDoc "Number of workers concurrently downloading modules.";
      default = 10;
      example = 32;
    };
    ...
    protocolWorkers = mkOption {
      type = types.int;
      description = mdDoc "Number of workers concurrently serving protocol paths.";
      default = 30;
    };
    ...
    enablePprof = mkOption {
      type = types.bool;
      description = mdDoc "Enable pprof endpoints.";
      default = false;
    };

    pprofPort = mkOption {
      type = types.port;
      description = mdDoc "Port number for pprof endpoints.";
      default = 3301;
      example = 443;
    };
    ...
    filterFile = mkOption {
      type = types.nullOr types.path;
      description = mdDoc ''Filename for the include exclude filter.'';
      default = null;
    ...
    robotsFile = mkOption {
      type = types.nullOr types.path;
      description = mdDoc ''Provides /robots.txt for net crawlers.'';
      default = null;
    ...
    timeout = mkOption {
      type = types.int;
      description = mdDoc "Timeout for external network calls in seconds.";
      default = 300;
      example = 3;
    };
    ...
    storageType = mkOption {
      ...
      description = mdDoc "Specifies the type of storage backend to use.";
      default = "disk";
    };

    tlsCertFile = mkOption {
      type = types.nullOr types.path;
      description = mdDoc "Path to the TLS certificate file.";
      default = null;
    ...
    tlsKeyFile = mkOption {
      type = types.nullOr types.path;
      description = mdDoc "Path to the TLS key file.";
      default = null;
    ...
    statsExporter = mkOption {
      ...
      description = mdDoc "Stats exporter to use.";
      default = null;
    };
    ...
    downloadURL = mkOption {
      type = types.str;
      description = mdDoc "URL used if DownloadMode is set to redirect.";
    ...
    singleFlight = {
      etcd = {
        endpoints = mkOption {
          type = types.listOf types.str;
          description = mdDoc "URLs that determine all distributed etcd servers.";
          default = [ ];
      ...
      redis = {
        endpoint = mkOption {
          type = types.str;
          description = mdDoc "URL of the redis server.";
          default = "";
          example = "localhost:6379";
        };
        password = mkOption {
          type = types.str;
          description = mdDoc "Password for the redis server. Warning: this is stored in plain text in the config file.";
          default = "";
          example = "swordfish";
        };
        ...
        lockConfig = {
          ttl = mkOption {
            type = types.int;
            description = mdDoc "TTL for the lock in seconds.";
            default = 900;
            example = 1;
          };
          timeout = mkOption {
            type = types.int;
            description = mdDoc "Timeout for the lock in seconds.";
            default = 15;
            example = 1;
          };
          maxRetries = mkOption {
            type = types.int;
            description = mdDoc "Maximum number of retries for the lock.";
            default = 10;
            example = 1;
          };
        };
      ...
      redisSentinel = {
        endpoints = mkOption {
          type = types.listOf types.str;
          description = mdDoc "URLs that determine all distributed redis servers.";
          default = [ ];
          example = [ "localhost:26379" ];
        };
        masterName = mkOption {
          type = types.str;
          description = mdDoc "Name of the sentinel master server.";
          default = "";
          example = "redis-1";
        };
        sentinelPassword = mkOption {
          type = types.str;
          description = mdDoc "Password for the sentinel server. Warning: this is stored in plain text in the config file.";
          default = "";
          example = "swordfish";
        };
    ...
    storage = {
      cdn = {
        endpoint = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "hostname of the CDN server.";
      ...
      disk = {
        rootPath = mkOption {
          type = types.nullOr types.path;
          description = mdDoc "Athens disk root folder.";
      ...
      gcp = {
        projectID = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "GCP project ID.";
          example = "my-project";
          default = null;
        };
        bucket = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "GCP backend storage bucket.";
          example = "my-bucket";
          default = null;
        };
        jsonKey = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Base64 encoded GCP service account key. Warning: this is stored in plain text in the config file.";
          default = null;
        };
      };
      ...
      minio = {
        endpoint = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Endpoint of the minio storage backend.";
          example = "minio.example.com:9001";
          default = null;
        };
        key = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Access key id for the minio storage backend.";
          example = "minio";
          default = null;
        };
        secret = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Secret key for the minio storage backend. Warning: this is stored in plain text in the config file.";
          example = "minio123";
          default = null;
        };
        enableSSL = mkOption {
          type = types.bool;
          description = mdDoc "Enable SSL for the minio storage backend.";
          default = false;
        };
        bucket = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Bucket name for the minio storage backend.";
          example = "gomods";
          default = null;
        };
        region = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Region for the minio storage backend.";
          example = "us-east-1";
          default = null;
        };
      };
      ...
      mongo = {
        url = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "URL of the mongo database.";
          example = "mongodb://localhost:27017";
          default = null;
        };
        defaultDBName = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Name of the mongo database.";
          example = "athens";
          default = null;
        };
        certPath = mkOption {
          type = types.nullOr types.path;
          description = mdDoc "Path to the certificate file for the mongo database.";
          example = "/etc/ssl/mongo.pem";
          default = null;
        };
        insecure = mkOption {
          type = types.bool;
          description = mdDoc "Allow insecure connections to the mongo database.";
          default = false;
        };
      };
      ...
      s3 = {
        region = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Region of the S3 storage backend.";
          example = "eu-west-3";
          default = null;
        };
        key = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Access key id for the S3 storage backend.";
          example = "minio";
          default = null;
        };
        secret = mkOption {
          type = types.str;
          description = mdDoc "Secret key for the S3 storage backend. Warning: this is stored in plain text in the config file.";
          default = "";
        };
        token = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Token for the S3 storage backend. Warning: this is stored in plain text in the config file.";
          default = null;
        };
        bucket = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Bucket name for the S3 storage backend.";
          example = "gomods";
          default = null;
        };
        forcePathStyle = mkOption {
          type = types.bool;
          description = mdDoc "Force path style for the S3 storage backend.";
          default = false;
        };
        useDefaultConfiguration = mkOption {
          type = types.bool;
          description = mdDoc "Use default configuration for the S3 storage backend.";
          default = false;
        };
        credentialsEndpoint = mkOption {
          type = types.str;
          description = mdDoc "Credentials endpoint for the S3 storage backend.";
          default = "";
        };
        awsContainerCredentialsRelativeURI = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Container relative url (used by fargate).";
          default = null;
        };
        endpoint = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Endpoint for the S3 storage backend.";
          default = null;
        };
      };
      ...
      azureblob = {
        accountName = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Account name for the Azure Blob storage backend.";
          default = null;
        };
        accountKey = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Account key for the Azure Blob storage backend. Warning: this is stored in plain text in the config file.";
          default = null;
        };
        containerName = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Container name for the Azure Blob storage backend.";
          default = null;
        };
      };
      ...
      external = {
        url = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "URL of the backend storage layer.";
    ...
    index = {
      mysql = {
        protocol = mkOption {
          type = types.str;
          description = mdDoc "Protocol for the MySQL database.";
          default = "tcp";
        };
        host = mkOption {
          type = types.str;
          description = mdDoc "Host for the MySQL database.";
          default = "localhost";
        };
        port = mkOption {
          type = types.int;
          description = mdDoc "Port for the MySQL database.";
          default = 3306;
        };
        user = mkOption {
          type = types.str;
          description = mdDoc "User for the MySQL database.";
          default = "root";
        };
        password = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Password for the MySQL database. Warning: this is stored in plain text in the config file.";
          default = null;
        };
        database = mkOption {
          type = types.str;
          description = mdDoc "Database name for the MySQL database.";
          default = "athens";
        };
        params = {
          parseTime = mkOption {
            type = types.nullOr types.str;
            description = mdDoc "Parse time for the MySQL database.";
            default = "true";
          };
          timeout = mkOption {
            type = types.nullOr types.str;
            description = mdDoc "Timeout for the MySQL database.";
            default = "30s";
          };
        };
      };
      ...
      postgres = {
        host = mkOption {
          type = types.str;
          description = mdDoc "Host for the Postgres database.";
          default = "localhost";
        };
        port = mkOption {
          type = types.int;
          description = mdDoc "Port for the Postgres database.";
          default = 5432;
        };
        user = mkOption {
          type = types.str;
          description = mdDoc "User for the Postgres database.";
          default = "postgres";
        };
        password = mkOption {
          type = types.nullOr types.str;
          description = mdDoc "Password for the Postgres database. Warning: this is stored in plain text in the config file.";
          default = null;
        };
        database = mkOption {
          type = types.str;
          description = mdDoc "Database name for the Postgres database.";
          default = "athens";
        };
        params = {
          connect_timeout = mkOption {
            type = types.nullOr types.str;
            description = mdDoc "Connect timeout for the Postgres database.";
            default = "30s";
          };
          sslmode = mkOption {
            type = types.nullOr types.str;
            description = mdDoc "SSL mode for the Postgres database.";
            default = "disable";
          };
        };
      };
