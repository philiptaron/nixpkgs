...
in
{
  ...
  options = {
    services.logrotate = {
      enable = mkEnableOption (mdDoc "the logrotate systemd service") // {
      ...
      settings = mkOption {
        ...
        type = types.attrsOf (types.submodule ({ name, ... }: {
          ...
          options = {
            enable = mkEnableOption (mdDoc "setting individual kill switch") // {
              default = true;
            };
            ...
            priority = mkOption {
              ...
              description = mdDoc ''
                ...
                the same as with `mkOrder`. Smaller values are inserted first.
              '';
            };
          };
