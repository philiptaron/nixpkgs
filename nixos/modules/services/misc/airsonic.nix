...
in
{
  options = {
    ...
    services.airsonic = {
      enable = mkEnableOption (mdDoc "Airsonic, the Free and Open Source media streaming server (fork of Subsonic and Libresonic)");

      user = mkOption {
        type = types.str;
        default = "airsonic";
        description = mdDoc "User account under which airsonic runs.";
      };
      ...
      war = mkOption {
        ...
        description = mdDoc "Airsonic war file to use.";
      };
