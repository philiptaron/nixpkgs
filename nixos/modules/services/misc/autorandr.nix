...
let
  ...
  profileModule = types.submodule {
    options = {
      ...
      config = mkOption {
        ...
        description = mdDoc "Per output profile configuration.";
        default = { };
      };

      hooks = mkOption {
        type = hooksModule;
        description = mdDoc "Profile hook scripts.";
        default = { };
      };
    };
  };
  ...
  configModule = types.submodule {
    options = {
      enable = mkOption {
        type = types.bool;
        description = mdDoc "Whether to enable the output.";
        default = true;
      };

      crtc = mkOption {
        type = types.nullOr types.ints.unsigned;
        description = mdDoc "Output video display controller.";
        default = null;
        example = 0;
      };
      ...
      primary = mkOption {
        type = types.bool;
        description = mdDoc "Whether output should be marked as primary";
        default = false;
      };

      position = mkOption {
        type = types.str;
        description = mdDoc "Output position";
        default = "";
        example = "5760x0";
      };
      ...
      mode = mkOption {
        type = types.str;
        description = mdDoc "Output resolution.";
        default = "";
        example = "3840x2160";
      };
      ...
      rate = mkOption {
        type = types.str;
        description = mdDoc "Output framerate.";
        default = "";
        example = "60.00";
      };
      ...
      gamma = mkOption {
        type = types.str;
        description = mdDoc "Output gamma configuration.";
        default = "";
      ...
      rotate = mkOption {
        ...
        description = mdDoc "Output rotate configuration.";
        default = null;
        example = "left";
      };
      ...
      dpi = mkOption {
        ...
        description = mdDoc "Output DPI configuration.";
        default = null;
        example = 96;
      };
        ...
        type = types.nullOr (types.submodule {
          options = {
            method = mkOption {
              ...
              description = mdDoc "Output scaling method.";
              default = "factor";
              example = "pixel";
            };
            ...
            x = mkOption {
              ...
              description = mdDoc "Horizontal scaling factor/pixels.";
            };

            y = mkOption {
              type = types.either types.float types.ints.positive;
              description = mdDoc "Vertical scaling factor/pixels.";
            };
          };
        });
        description = mdDoc ''
  ...
  hooksModule = types.submodule {
    options = {
      postswitch = mkOption {
        ...
        description = mdDoc "Postswitch hook executed after mode switch.";
        default = { };
      };

      preswitch = mkOption {
        type = types.attrsOf hookType;
        description = mdDoc "Preswitch hook executed before mode switch.";
        default = { };
      };
...
in {
  ...
  options = {
    ...
    services.autorandr = {
      enable = mkEnableOption (mdDoc "handling of hotplug and sleep events by autorandr");
      ...
      ignoreLid = mkOption {
        default = false;
        type = types.bool;
        description = mdDoc "Treat outputs as connected even if their lids are closed";
      };

      hooks = mkOption {
        type = hooksModule;
        description = mdDoc "Global hook scripts";
        default = { };
        example = literalExpression ''
          {
            postswitch = {
      ...
      profiles = mkOption {
        ...
        description = mdDoc "Autorandr profiles specification.";
        default = { };
        example = literalExpression ''
          {
            "work" = {
