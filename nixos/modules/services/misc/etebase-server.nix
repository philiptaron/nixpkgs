  ...
  options = {
    services.etebase-server = {
      ...
      dataDir = mkOption {
        ...
        description = mdDoc "Directory to store the Etebase server data.";
      };
          ...
          options = {
            global = {
              ...
              static_root = mkOption {
                ...
                description = mdDoc "The directory for static files.";
              };
              media_root = mkOption {
                type = types.str;
                default = "${cfg.dataDir}/media";
                defaultText = literalExpression ''"''${config.services.etebase-server.dataDir}/media"'';
                description = mdDoc "The media directory.";
              };
            };
            allowed_hosts = {
            ...
            database = {
              engine = mkOption {
                ...
                description = mdDoc "The database engine to use.";
              };
              name = mkOption {
                type = types.str;
      ...
      user = mkOption {
        type = types.str;
        default = defaultUser;
        description = mdDoc "User under which Etebase server runs.";
      };
    };
  };
