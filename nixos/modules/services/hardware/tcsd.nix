  ...
  options = {
    ...
    services.tcsd = {
      ...
      user = mkOption {
        default = "tss";
        type = types.str;
        description = mdDoc "User account under which tcsd runs.";
      };

      group = mkOption {
        default = "tss";
        type = types.str;
        description = mdDoc "Group account under which tcsd runs.";
      };
      ...
      firmwarePCRs = mkOption {
        ...
        type = types.str;
        description = mdDoc "PCR indices used in the TPM for firmware measurements.";
      };

      kernelPCRs = mkOption {
        default = "8,9,10,11,12";
        type = types.str;
        description = mdDoc "PCR indices used in the TPM for kernel measurements.";
      };
