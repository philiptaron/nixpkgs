...
in
{
  options = {
    services.galene = {
      enable = mkEnableOption (mdDoc "Galene Service");
      ...
      user = mkOption {
        type = types.str;
        default = "galene";
        description = mdDoc "User account under which galene runs.";
      };

      group = mkOption {
        type = types.str;
        default = "galene";
        description = mdDoc "Group under which galene runs.";
      };
      ...
      httpAddress = mkOption {
        type = types.str;
        default = "";
        description = mdDoc "HTTP listen address for galene.";
      };
      ...
      staticDir = mkOption {
        ...
        description = mdDoc "Web server directory.";
      };
      ...
      recordingsDir = mkOption {
        ...
        description = mdDoc "Recordings directory.";
      };
  ...
  meta.maintainers = with maintainers; [ rgrunbla ];
}
