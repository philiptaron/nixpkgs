...

{
  options = {
    services.jira = {
      enable = mkEnableOption (mdDoc "Atlassian JIRA service");

      user = mkOption {
        type = types.str;
        default = "jira";
        description = mdDoc "User which runs JIRA.";
      };

      group = mkOption {
        type = types.str;
        default = "jira";
        description = mdDoc "Group which runs JIRA.";
      };

      home = mkOption {
        type = types.str;
        default = "/var/lib/jira";
        description = mdDoc "Home directory of the JIRA instance.";
      };
      ...
      sso = {
        ...
        applicationName = mkOption {
          type = types.str;
          example = "jira";
          description = mdDoc "Exact name of this JIRA instance in Crowd";
        };

        applicationPasswordFile = mkOption {
          type = types.str;
          description = mdDoc "Path to the file containing the application password of this JIRA instance in Crowd";
        };
