...
in
{
  options.services.chatgpt-retrieval-plugin = {
    enable = mkEnableOption (mdDoc "chatgpt-retrieval-plugin service");

    port = mkOption {
      type = types.port;
      default = 8080;
      description = mdDoc "Port the chatgpt-retrieval-plugin service listens on.";
    };
    ...
    host = mkOption {
      ...
      default = "127.0.0.1";
      example = "0.0.0.0";
      description = mdDoc "The hostname or IP address for chatgpt-retrieval-plugin to bind to.";
    };
    ...
    datastore = mkOption {
      ...
      default = "qdrant";
      description = mdDoc "This specifies the vector database provider you want to use to store and query embeddings.";
    };
