  ...
  options = {
    services.resilio = {
      ...
      encryptLAN = mkOption {
        type = types.bool;
        default = true;
        description = mdDoc "Encrypt LAN data.";
      };
      ...
      apiKey = mkOption {
        type = types.str;
        default = "";
        description = mdDoc "API key, which enables the developer API.";
      };
      ...
      directoryRoot = mkOption {
        ...
        default = "";
        example = "/media";
        description = mdDoc "Default directory to add folders in the web UI.";
      };
