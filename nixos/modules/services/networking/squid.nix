  ...
  options = {
    ...
    services.squid = {
      ...
      enable = mkOption {
        type = types.bool;
        default = false;
        description = mdDoc "Whether to run squid web proxy.";
      };
      ...
      proxyAddress = mkOption {
        ...
        default = null;
        description = mdDoc "IP address on which squid will listen.";
      };

      proxyPort = mkOption {
        type = types.int;
        default = 3128;
        description = mdDoc "TCP port on which squid will listen.";
      };
