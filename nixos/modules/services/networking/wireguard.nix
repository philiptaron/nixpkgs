  ...
  interfaceOpts = { ... }: {
    ...
    options = {
      ...
      ips = mkOption {
        ...
        description = mdDoc "The IP addresses of the interface.";
      };
      ...
      postSetup = mkOption {
        ...
        default = "";
        type = with types; coercedTo (listOf str) (concatStringsSep "\n") lines;
        description = mdDoc "Commands called at the end of the interface setup.";
      };
      ...
      postShutdown = mkOption {
        ...
        default = "";
        type = with types; coercedTo (listOf str) (concatStringsSep "\n") lines;
        description = mdDoc "Commands called after shutting down the interface.";
      };
      ...
      peers = mkOption {
        default = [];
        description = mdDoc "Peers linked to the interface.";
      ...
      socketNamespace = mkOption {
        ...
        type = with types; nullOr str;
        example = "container";
        description = mdDoc ''The pre-existing network namespace in which the
      ...
      interfaceNamespace = mkOption {
        ...
        type = with types; nullOr str;
        example = "init";
        description = mdDoc ''The pre-existing network namespace the WireGuard
  ...
  peerOpts = self: {
    ...
    options = {
      ...
      name = mkOption {
        ...
        example = "bernd";
        type = types.str;
        description = mdDoc "Name used to derive peer unit name.";
      };
      ...
      allowedIPs = mkOption {
        ...
        type = with types; listOf str;
        description = mdDoc ''List of IP (v4 or v6) addresses with CIDR masks from
      ...
      persistentKeepalive = mkOption {
        ...
        type = with types; nullOr int;
        example = 25;
        description = mdDoc ''This is optional and is by default off, because most
    ...
    in nameValuePair serviceName
      {
        ...
        unitConfig = optionalAttrs dynamicRefreshEnabled {
