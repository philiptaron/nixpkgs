...
let
  ...
  interfaceOpts = { ... }: {
    options = {
      ...
      autostart = mkOption {
        description = mdDoc "Whether to bring up this interface automatically during boot.";
        default = true;
        example = false;
        type = types.bool;
      };
      ...
      dns = mkOption {
        ...
        default = [];
        type = with types; listOf str;
        description = mdDoc "The IP addresses of DNS servers to configure.";
      };
  ...
  peerOpts = {
    options = {
      publicKey = mkOption {
        ...
        type = types.str;
        description = mdDoc "The base64 public key to the peer.";
      };
      ...
      endpoint = mkOption {
        ...
        type = with types; nullOr str;
        description = mdDoc ''Endpoint IP or hostname of the peer, followed by a colon,
