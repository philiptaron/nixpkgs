    ...
    services.hans = {
        ...
        type = types.attrsOf (types.submodule (
        {
          options = {
            server = mkOption {
              type = types.str;
              default = "";
              description = mdDoc "IP address of server running hans";
              example = "192.0.2.1";
            };
      ...
      server = {
        enable = mkOption {
          type = types.bool;
          default = false;
          description = mdDoc "enable hans server";
        };

        ip = mkOption {
          type = types.str;
          default = "";
          description = mdDoc "The assigned ip range";
        ...
        respondToSystemPings = mkOption {
          type = types.bool;
          default = false;
          description = mdDoc "Force hans respond to ordinary pings";
        };
