...
let
  ...
  bitcoindOpts = { config, lib, name, ...}: {
    options = {
      ...
      enable = mkEnableOption (mdDoc "Bitcoin daemon");
      ...
      configFile = mkOption {
        ...
        description = mdDoc "The configuration file path to supply bitcoind.";
      };
      ...
      extraConfig = mkOption {
        ...
        example = ''
          ...
          logips=1
        '';
        description = mdDoc "Additional configurations to be appended to {file}`bitcoin.conf`.";
      };
      ...
      rpc = {
        port = mkOption {
          ...
          default = null;
          description = mdDoc "Override the default port on which to listen for JSON-RPC connections.";
        };
        users = mkOption {
          default = {};
          ...
          description = mdDoc "RPC user information for JSON-RPC connections.";
        };
      };
      ...
      pidFile = mkOption {
        ...
        description = mdDoc "Location of bitcoind pid file.";
      };

      testnet = mkOption {
        type = types.bool;
        default = false;
        description = mdDoc "Whether to use the testnet instead of mainnet.";
      };
...
in
{
  ...
  options = {
    services.bitcoind = mkOption {
      ...
      default = {};
      description = mdDoc "Specification of one or more bitcoind instances.";
    };
  };
