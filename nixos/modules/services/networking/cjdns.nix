...
let
  ...
  { options =
    { password = mkOption {
        type = types.str;
        description = mdDoc "Authorized password to the opposite end of the tunnel.";
      };
      login = mkOption {
        default = "";
        type = types.str;
        description = mdDoc "(optional) name your peer has for you";
      };
      peerName = mkOption {
        default = "";
        type = types.str;
        description = mdDoc "(optional) human-readable name for peer";
      };
      publicKey = mkOption {
        type = types.str;
        description = mdDoc "Public key at the opposite end of the tunnel.";
      };
      hostname = mkOption {
        default = "";
        example = "foobar.hype";
        type = types.str;
        description = mdDoc "Optional hostname to add to /etc/hosts; prevents reverse lookup failures.";
      };
    };
  };
