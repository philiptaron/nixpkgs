...
in
{
  options = {
    ...
    sslCertificate = mkOption {
      ...
      description = mdDoc "Path to server SSL certificate.";
    };

    sslCertificateKey = mkOption {
      type = types.path;
      example = "/var/host.key";
      description = mdDoc "Path to server SSL certificate key.";
    };
    ...
    sslTrustedCertificate = mkOption {
      ...
      description = mdDoc "Path to root SSL certificate for stapling and client certificates.";
    };
    ...
    locations = mkOption {
      ...
      '';
      description = mdDoc "Declarative location config";
    };
  };
}
