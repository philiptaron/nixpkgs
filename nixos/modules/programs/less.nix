...

{
  options = {
    ...
    programs.less = {
      ...
      enable = mkEnableOption (mdDoc "less");
      ...
      commands = mkOption {
        ...
        description = mdDoc "Defines new command keys.";
      };
      ...
      lineEditingKeys = mkOption {
        ...
        description = mdDoc "Defines new line-editing keys.";
      };
      ...
      envVariables = mkOption {
        ...
        description = mdDoc "Defines environment variables.";
      };
