...
let
  ...
  { options = {
      address = mkOption {
        type = types.str;
        description = mdDoc "IPv${toString v} address of the network.";
      };
      ...
      via = mkOption {
        ...
        default = null;
        description = mdDoc "IPv${toString v} address of the next hop.";
      };
  ...
  gatewayOpts = { ... }: {
    ...
    options = {
      ...
      address = mkOption {
        type = types.str;
        description = mdDoc "The default gateway address.";
      };
      ...
      interface = mkOption {
        ...
        default = null;
        example = "enp0s3";
        description = mdDoc "The default gateway interface.";
      };
      ...
      metric = mkOption {
        ...
        default = null;
        example = 42;
        description = mdDoc "The default gateway metric/preference.";
      };
  ...
  interfaceOpts = { name, ... }: {
    ...
    options = {
      name = mkOption {
        example = "eth0";
        type = types.str;
        description = mdDoc "Name of the interface.";
      };

      tempAddress = mkOption {
        type = types.enum (attrNames tempaddrValues);
      ...
      wakeOnLan = {
        enable = mkOption {
          type = types.bool;
          default = false;
          description = mdDoc "Whether to enable wol on this interface.";
        };
        policy = mkOption {
  ...
  vswitchInterfaceOpts = {name, ...}: {
    ...
    options = {
      ...
      vlan = mkOption {
        description = mdDoc "Vlan tag to apply to interface";
        example = 10;
        type = types.nullOr types.int;
        default = null;
      };
      ...
      type = mkOption {
        description = mdDoc "Openvswitch type to assign to interface";
        example = "internal";
        type = types.nullOr types.str;
        default = null;
      };
...

{
    ...
    networking.vswitches = mkOption {
      ...
      type = with types; attrsOf (submodule {
        ...
        options = {
          ...
          interfaces = mkOption {
            description = mdDoc "The physical network interfaces connected by the vSwitch.";
      ...
      type = with types; attrsOf (submodule {
        ...
        options = {
          ...
          interfaces = mkOption {
            ...
            type = types.listOf types.str;
            description =
              mdDoc "The physical network interfaces connected by the bridge.";
          };

          rstp = mkOption {
            default = false;
            type = types.bool;
            description = mdDoc "Whether the bridge interface should enable rstp.";
          };
        ...
        type = with types; attrsOf (submodule {
          ...
          options = {
            ...
            interfaces = mkOption {
              ...
              type = types.listOf types.str;
              description = mdDoc "The interfaces to bond together";
            };
      ...
      type = with types; attrsOf (submodule {
        options = {
          ...
          interface = mkOption {
            example = "enp4s0";
            type = types.str;
            description = mdDoc "The interface the macvlan will transmit packets through.";
          };
          ...
          mode = mkOption {
            ...
            type = types.nullOr types.str;
            example = "vepa";
            description = mdDoc "The mode of the macvlan device.";
          };
      ...
      type = with types; attrsOf (submodule {
        ...
        options = {
          ...
          id = mkOption {
            example = 1;
            type = types.int;
            description = mdDoc "The vlan identifier";
          };

          interface = mkOption {
            example = "enp4s0";
            type = types.str;
            description = mdDoc "The interface the vlan will transmit packets through.";
          };
      ...
      type = with types; attrsOf (submodule {
        ...
        options = {
          ...
          device = mkOption {
            type = types.str;
            example = "wlp6s0";
            description = mdDoc "The name of the underlying hardware WLAN device as assigned by `udev`.";
          };
          ...
          meshID = mkOption {
            type = types.nullOr types.str;
            default = null;
            description = mdDoc "MeshID of interface with type `mesh`.";
          };
          ...
          fourAddr = mkOption {
            type = types.nullOr types.bool;
            default = null;
            description = mdDoc "Whether to enable `4-address mode` with type `managed`.";
          };
  ...
  config = {
    ...
    warnings = (concatMap (i: i.warnings) interfaces) ++ (optional
    ...
    systemd.services.domainname = mkIf (cfg.domain != null) {
