...
let
  ...
  urlToName =
    ...
    let
      ...
      appendShort = optionalString ((builtins.match "[a-f0-9]*" rev) != null) "-${shortRev}";
    in
...
makeOverridable (extendMkDerivation {
  ...
  extendDrvArgs =
    ...
    lib.fetchers.withNormalizedHash { } (
      ...
      #   ../../../doc/build-helpers/fetchers.chapter.md
      {
        ...
        name ? urlToName {
          inherit url;
          rev = revOrTag finalAttrs.revCustom finalAttrs.tag;
      ...
      */
      ...
      // {
        ...
        ++ optionals fetchLFS [ git-lfs ]
        ++ nativeBuildInputs;

        hash =
          if outputHashAlgo == null || outputHash == "" || hasPrefix outputHashAlgo outputHash then
            outputHash
          else
        ...
        sparseCheckout =
          let
            default = optional (finalAttrs.rootDir != "") finalAttrs.rootDir;
          in
          defaultTo default sparseCheckout;
        sparseCheckoutText =
          # Changed to throw on 2023-06-04
          assert (
            isList finalAttrs.sparseCheckout
        ...
        leaveDotGit =
          if leaveDotGit != null then
            ...
            deepClone || fetchTags;
        nonConeMode = defaultTo (finalAttrs.rootDir != "") nonConeMode;
        inherit tag;
        revCustom = rev;
        rev = getRevWithTag {
        ...
        meta = meta // {
          identifiers = {
            purlParts = {
              ...
              spec = "${name}?vcs_url=${url}@${(revOrTag rev tag)}";
            };
          }
          // meta.identifiers or { };
        };
